...
import ReportHistorySuccess from './ReportHistorySuccess';

function ReportHistoryAdmin() {
    ...
    useEffect(()=>{
        try{
            const fetchData = async () =>{
                const response = await axios.get(`${ApiConfig.apiURL}reportViewed`);
    ...
    return (
        <div className='xl:ml-64 xl:mb-10'>
            <SidebarAd />
            <div className='flex items-center justify-center mt-10 p-4'>
              <div className='max-w-screen-xl w-full'>
                  <div className='text-start text-2xl pb-2 font-medium border-b border-b-300 mb-5'>Report History</div>
                  <div className='flex items-center justify-between bg-green-700 p-4 pb-2 rounded-t-md'>
                      <div className='text-white font-medium tracking-wider'>VIEWED FORM</div>
...
export default ReportHistoryAdmin